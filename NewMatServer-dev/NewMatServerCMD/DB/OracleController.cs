...
namespace NewMatServerCMD.DB
{
    class OracleController
    {
        ...
        public static string ttshopPkg(string connStr, string pkg_name, int pflag, string codestr, string clientName, string appliacationName, string stockNo, string isCache)
        {
            ...
            OracleParameter p4 = new OracleParameter("return_value", OracleType.Int16, 2);
            p4.Direction = ParameterDirection.ReturnValue;
            OracleParameter p5 = new OracleParameter("psno", OracleType.Int16, 2);
            p1.Direction = ParameterDirection.InputOutput;
            OracleParameter p6 = new OracleParameter("stockno", OracleType.VarChar, 2);
            p1.Direction = ParameterDirection.Input;
            OracleParameter p7 = new OracleParameter("transtr", OracleType.VarChar, 120);
            p1.Direction = ParameterDirection.Input;
            ...
            try
            {
                cmd.Parameters["pflag"].Value = pflag;
                cmd.Parameters["codestr"].Value = codestr;
                cmd.Parameters["psno"].Value = 0;
                cmd.Parameters["stockno"].Value = "00";
                cmd.Parameters["transtr"].Value = "0";
                cmd.ExecuteNonQuery();
                //outstr = m_command.Parameters["outstr"].Value.ToString();
                outstr = cmd.Parameters["outstr"].Value.ToString();
        ...
        public static bool AdoSql(string connStr,string sqlStr)
        {
            OracleConnection conn = new OracleConnection(connStr);
        ...
        public static DataSet GetDataSet(string connStr, string sqlStr)
        {
            ...
            OracleDataAdapter oraDap = new OracleDataAdapter(sqlStr, conn);
